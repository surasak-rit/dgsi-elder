...
> [!tip] คู่มือติดตั้งเชิงปฏิบัติ
> เอกสารนี้คือ**พิมพ์เขียว (ทำไม/อะไร)** — สำหรับขั้นตอนลงมือทำจริงพร้อมคำสั่งและ YAML ดู [[13 - คู่มือติดตั้งและตั้งค่า CI-CD (Setup & Configuration Guide)]]
